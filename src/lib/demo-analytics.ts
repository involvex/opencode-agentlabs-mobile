...
export const DEMO_STEP_PERMISSION_REPLIED = {
  index: 1,
...
export function demoStepAdvancedProps(
  reply: DemoPermissionReply,
): AnalyticsProps {
  return {
...
export function demoCompletedOutcome(
  reply: DemoPermissionReply,
): "completed" | "denied" {
...
export function demoExitedToConnectProps(
