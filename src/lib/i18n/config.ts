...
// eslint-disable-next-line import/no-named-as-default-member -- i18next instance methods must be called on the instance
...
export function setAppLocale(preference: LocalePreference): void {
  ...
  if (i18next.language !== resolved)
    // eslint-disable-next-line import/no-named-as-default-member -- i18next instance method
