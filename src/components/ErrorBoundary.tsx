...
// the component tree and presents a recovery UI that lets the user share a diagnostic report
...
export class ErrorBoundary extends React.Component<Props, State> {
  ...
  handleShare = () => {
    ...
    shareReport(report).catch((e) =>
      log.warn("boundary", "share failed", String(e)),
    );
  };
        ...
        <ScrollView contentContainerStyle={styles.content}>
          ...
          <View style={styles.card}>
            <Text style={styles.cardLabel}>
              {i18n.t("errorBoundary.errorLabel")}
            </Text>
          ...
          {stack ? (
            <View style={styles.card}>
              <Text style={styles.cardLabel}>
                {i18n.t("errorBoundary.stackLabel")}
              </Text>
          ...
          {compStack ? (
            <View style={styles.card}>
              <Text style={styles.cardLabel}>
                {i18n.t("errorBoundary.componentLabel")}
              </Text>
              <Text style={styles.code} selectable>
                {compStack}
              </Text>
          ...
          <View style={styles.actions}>
            ...
            >
              <Text style={styles.buttonPrimaryText}>
                {i18n.t("errorBoundary.shareButton")}
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
